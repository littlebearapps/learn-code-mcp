...
class LearnCodeCLI {
    ...
    async getCodeInput(args, options) {
    ...
    generateMCPCommands(code, options) {
        return [
            // Initialize
            {
                jsonrpc: '2.0',
    ...
    extractExplanationFromMCPOutput(output) {
        try {
    ...
    formatOutput(explanation, options) {
